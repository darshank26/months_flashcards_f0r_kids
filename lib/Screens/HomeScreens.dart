...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<String> _monthsNames = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
                          ...
                          child:  Column(
                            ...
                            children: [
                              ...
                              Image.asset('assets/images/${index+1}.png',
                               ...
                               toggle  ?  Text("${_monthsNames.elementAt(index)}",
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        if (_pageController.page!.round() > 0) {
                                          ...
                                          if(check_volume)
                                            {
                                              ftts.speak( _monthsNames.elementAt(index-1));
                                            }
...
*/
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        if(check_volume)
                                          {
                                            ftts.speak( _monthsNames.elementAt(index));
                                          }
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        if (_pageController.page!.round() < _monthsNames.length - 1) {
